...
可复现的两分钟内 MP4 底片和配音稿在 [video_assets](video_assets)；在装有 FFmpeg 与 Edge 的 Windows 上运行 `./video_assets/render_demo_video.ps1`，会生成不含密钥的 1080p 演示视频，并自动嵌入本地 Web 控制台画面。
